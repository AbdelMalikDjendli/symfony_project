...
class getMatchFormHandlerService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 4).'/src/FormHandler/MatchFormHandler.php';
        ...
        return $container->privates['App\\FormHandler\\MatchFormHandler'] = new \App\FormHandler\MatchFormHandler($a, ($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
