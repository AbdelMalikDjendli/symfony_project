...
class MatchController extends UserAccessController
{
    ...
    {
        $this->preventAccessToNotConnectedUser($this->getUser());
        ...
        $form->handleRequest($request);
            ...
            if ($form->isSubmitted() && $form->isValid()) {
                ...
                return $this->redirectToProfil('Votre match a bien été créé.', $user);
            }
    ...
    public function addResult(Request $request, int $id):Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToProfil('Le résultat a bien été pris en compte.', $this->commonServices->getUserConnected($mail));
        }
