 ...
 */
final class Version20230214174816 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP photodeprofil, DROP note, DROP nb_note');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD photodeprofil BLOB DEFAULT NULL, ADD note INT DEFAULT NULL, ADD nb_note INT DEFAULT NULL');
    }
}
