 ...
 */
final class Version20230130145959 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event DROP team1, DROP team2');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD team1 VARCHAR(255) NOT NULL, ADD team2 VARCHAR(255) DEFAULT NULL');
    }
}
