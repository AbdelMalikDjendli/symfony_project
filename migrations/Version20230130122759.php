 ...
 */
final class Version20230130122759 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD team1 VARCHAR(255) NOT NULL, ADD team2 VARCHAR(255) NOT NULL');
    }
}
