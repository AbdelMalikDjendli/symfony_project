 ...
 */
final class Version20230214173940 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP photo de profil, DROP note, DROP nb_note');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD photo de profil BLOB DEFAULT NULL, ADD note INT DEFAULT NULL, ADD nb_note INT DEFAULT NULL');
    }
}
